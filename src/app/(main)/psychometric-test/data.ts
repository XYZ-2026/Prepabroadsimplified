...
export const GRADE_10_RIASEC_QUESTIONS: Question[] = [
  { id: 41, text: '🏫 Which school club would you immediately join?', options: ['Robotics or Tinkering Lab 🤖', 'Art, Drama, or Photography Club 📸', 'Debate or Business Club 💼', 'Peer Mentoring or Social Service Club 🤝'], option_types: ['R', 'A', 'E', 'S'], correct: -1, trait: 'riasec' },
  { id: 42, text: '🎮 When you have free time, what sounds the most fun?', options: ['Building PCs, fixing gadgets, or doing DIY 🛠️', 'Solving puzzles, coding, or reading cool facts 🧠', 'Sketching, making videos, or playing music 🎸', 'Hanging out and chatting with friends 💬'], option_types: ['R', 'I', 'A', 'S'], correct: -1, trait: 'riasec' },
  { id: 43, text: '📺 What kind of YouTube content do you binge-watch?', options: ['How engines work, tech reviews, or cool machines 🏎️', 'Documentaries, science experiments, or history mysteries 🔬', 'Animation, movie reviews, or art tutorials 🎨', 'Shark Tank, business case studies, or motivation 📈'], option_types: ['R', 'I', 'A', 'E'], correct: -1, trait: 'riasec' },
  { id: 44, text: '🛠️ For a weekend project, you would rather:', options: ['Repair a broken bike or appliance in the house 🔧', 'Start a small side-hustle or plan an event 💼', 'Write a short story or edit a cool aesthetic video 🎥', 'Organise a neighbourhood sports match or cleanup ⚽'], option_types: ['R', 'E', 'A', 'S'], correct: -1, trait: 'riasec' },
  { id: 45, text: '📚 Which subject do you look forward to the most?', options: ['Physics, Maths, or Computer Science 💻', 'Accounts, Economics, or Commerce 📊', 'English Literature, Fine Arts, or History 🎭', 'Biology, Psychology, or Sociology 🧬'], option_types: ['I', 'C', 'A', 'S'], correct: -1, trait: 'riasec' },
  { id: 46, text: '🏆 If you entered a school competition, it would be:', options: ['A Science Exhibition or Hackathon 🔬', 'A Creative Writing or Graphic Design contest 🖌️', 'A Model UN, Debate, or Pitch competition 🗣️', 'A sports tournament where you represent your house 🏅'], option_types: ['I', 'A', 'E', 'R'], correct: -1, trait: 'riasec' },
  { id: 47, text: '🌟 What role fits you best in a group project?', options: ['The Presenter / Project Manager 📋', 'The Researcher finding all the facts 🔍', 'The Designer making the slides look amazing ✨', 'The Coordinator keeping the team happy 🤝'], option_types: ['E', 'I', 'A', 'S'], correct: -1, trait: 'riasec' },
  { id: 48, text: '🎒 You win a free pass to one of these places. Where do you go?', options: ['A massive auto expo or tech convention 🚘', 'A nature reserve or a high-tech laboratory 🌿', 'A live music concert or an art gallery opening 🎫', 'A community event or a youth leadership summit 🌍'], option_types: ['R', 'I', 'A', 'S'], correct: -1, trait: 'riasec' },
...
export const FBQ_GRADE10: { sections: Section[] } = {
  sections: [
    ...
    },
    {
      ...
      questions: GRADE_10_PERSONALITY_QUESTIONS,
    },
    {
      ...
      questions: GRADE_10_RIASEC_QUESTIONS,
    },
    {
      ...
      questions: GRADE_10_VARK_QUESTIONS,
    },
    {
      ...
      questions: GRADE_10_VALUES_QUESTIONS,
    },
  ]
};
