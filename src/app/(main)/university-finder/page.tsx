...
export const metadata: Metadata = {
  title: 'AI University Finder & Predictor | Find Target Universities Abroad',
  description:
    'Match your GPA, GRE/GMAT, IELTS/TOEFL scores, budget, and major with top universities across USA, UK, Germany, Canada, and Australia.',
  keywords: [
    'university finder',
    'university predictor',
    'study abroad university matcher',
    'USA university predictor',
