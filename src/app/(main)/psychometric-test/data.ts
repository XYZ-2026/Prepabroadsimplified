...
export const GRADE_10_PERSONALITY_QUESTIONS: Question[] = [
  // OPENNESS (5)
  { id: 21, text: '💡 When the teacher gives a totally open-ended project, I get excited to come up with a unique, creative idea.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'openness' },
  { id: 22, text: '🌍 I love learning about things outside my syllabus, like space, history mysteries, or how new tech works.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'openness' },
  { id: 23, text: '📋 I prefer subjects where there is only one correct answer, rather than subjects where I have to interpret things.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'openness', reverse: true },
  { id: 24, text: '🎸 In my free time, I really enjoy creative hobbies like playing an instrument, sketching, coding, or writing.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'openness' },
  { id: 25, text: '🚀 I am always the first among my friends to try out a new app, game, or trend.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'openness' },
  
  // CONSCIENTIOUSNESS (5)
  { id: 26, text: '📅 I keep track of my assignments and exam dates, and start studying well before the last night.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'conscientiousness' },
  { id: 27, text: '🗂️ My notes are usually neat, organised, and easy for me (or my friends) to study from.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'conscientiousness' },
  { id: 28, text: '🎯 When I set a goal for myself (like getting a certain grade), I work hard until I achieve it.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'conscientiousness' },
  { id: 29, text: '😴 I tend to procrastinate and leave things like homework or chores until the very last minute.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'conscientiousness', reverse: true },
  { id: 30, text: '✅ If I tell my friends or teachers I will do something, they know they can count on me to get it done.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'conscientiousness' },
  
  // EXTRAVERSION (4)
  { id: 31, text: '🙋‍♂️ In class discussions, I frequently raise my hand and enjoy sharing my opinions out loud.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'extraversion' },
  { id: 32, text: '🎉 After a long week, hanging out with a big group of friends completely recharges my energy.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'extraversion' },
  { id: 33, text: '🗣️ I feel comfortable taking the lead in a group project and directing what needs to be done.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'extraversion' },
  { id: 34, text: '🎧 I generally prefer staying home with a good book, game, or movie rather than going to a busy party.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'extraversion', reverse: true },
  
  // AGREEABLENESS (3)
  { id: 35, text: '🤝 If a classmate misses school, I usually offer to share my notes and help them catch up.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'agreeableness' },
  { id: 36, text: '🕊️ I try to avoid arguments with my friends and prefer keeping the peace when there is a disagreement.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'agreeableness' },
  { id: 37, text: '😤 If someone in a group project isn\'t doing their fair share, I get annoyed and tell them off bluntly.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'agreeableness', reverse: true },
  
  // NEUROTICISM (3)
  { id: 38, text: '😰 I get very stressed and anxious before important exams, to the point where it affects my sleep.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'neuroticism' },
  { id: 39, text: '💪 If I get a lower mark than expected, I bounce back quickly and focus on doing better next time.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'neuroticism', reverse: true },
  { id: 40, text: '😌 Even when I have a lot of assignments piling up, I generally stay calm and don\'t panic.', options: ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'], correct: -1, trait: 'neuroticism', reverse: true },
];

export const GRADE_10_RIASEC_QUESTIONS: Question[] = [
  { id: 41, text: '🎓 You must pick your primary Class 11 stream focus. Which track calls to you most?', options: ['Engineering & Physical Sciences (PCM + Coding) ⚙️', 'Medicine & Life Sciences (PCB + Biotech) 🔬', 'Business, Finance & Economics (Commerce) 📈', 'Design, Media & Social Sciences (Humanities) 🎨'], option_types: ['R', 'I', 'E', 'A'], correct: -1, trait: 'riasec' },
  { id: 42, text: '📚 If your school offered a special elective combination, which would you pick?', options: ['Applied Physics, Advanced Calculus & Robotics 🤖', 'Genetics, Biochemistry & Human Anatomy 🧬', 'Financial Markets, Entrepreneurship & Data Analytics 📊', 'Psychology, International Relations & Creative Writing ✍️'], option_types: ['R', 'I', 'C', 'A'], correct: -1, trait: 'riasec' },
  { id: 43, text: '💼 You get a 2-week shadowing opportunity. Which setting excites you most?', options: ['An automotive engineering workshop or AI lab 🚗', 'A multi-speciality hospital or medical research centre 🏥', 'A high-growth venture capital firm or trading floor 🏢', 'A film production studio or human rights foundation 🎬'], option_types: ['R', 'I', 'E', 'S'], correct: -1, trait: 'riasec' },
  { id: 44, text: '🧠 Which real-world challenge would you feel most proud to solve?', options: ['Designing hardware/software to automate renewable energy ⚡', 'Discovering targeted therapies for rare genetic diseases 🔬', 'Building a multi-million dollar brand or economic model 💰', 'Reforming education or creating impactful artistic movements 🌍'], option_types: ['R', 'I', 'E', 'S'], correct: -1, trait: 'riasec' },
  { id: 45, text: '📖 When preparing for Class 11, which subject workload would you find most engaging?', options: ['Solving complex Physics and Mathematics numericals 📐', 'Memorising detailed biological processes and organic chemistry 🧪', 'Analysing company balance sheets and economic trends 📊', 'Reading literature, historical cases, and philosophical essays 📜'], option_types: ['R', 'I', 'C', 'A'], correct: -1, trait: 'riasec' },
  { id: 46, text: '🏆 If you entered a national competition in Class 11, which would you target?', options: ['National Innovation & Hardware Hackathon 💻', 'National Science & Bio-Olympiad 🔬', 'National Young Entrepreneurs Pitch Challenge 🚀', 'National Model UN or Creative Writing Championship 🗣️'], option_types: ['R', 'I', 'E', 'A'], correct: -1, trait: 'riasec' },
  { id: 47, text: '🌟 In a high-stakes group project, which lead role do you naturally step into?', options: ['Technical Lead: Building the working model or technical code 🛠️', 'Research Lead: Gathering scientific data and verifying accuracy 🔍', 'Finance & Pitch Lead: Managing budget, pitch deck, and strategy 📈', 'Creative & Communications Lead: Designing slides and storytelling 🎨'], option_types: ['R', 'I', 'E', 'A'], correct: -1, trait: 'riasec' },
  { id: 48, text: '🎒 You win a summer scholarship pass to a top university. Which department do you join?', options: ['Department of Robotics & Civil/Mechanical Engineering 🏗️', 'Department of Molecular Biology & Medical Research 🧬', 'Department of Business Administration & Global Trade 💼', 'Department of Psychology, Journalism & Fine Arts 🎭'], option_types: ['R', 'I', 'E', 'A'], correct: -1, trait: 'riasec' },
  { id: 49, text: '💻 On a laptop, you are most likely to be:', options: ['Playing simulation games or modding 🎮', 'Organising spreadsheets or managing finances 📈', 'Editing photos, making music, or designing 🎼', 'Writing a blog or managing social media for a club 📱'], option_types: ['R', 'C', 'A', 'E'], correct: -1, trait: 'riasec' },
  { id: 50, text: '🌈 When you think about a future career, what sounds awesome?', options: ['Engineer, Pilot, or Architect 🏗️', 'Scientist, Data Analyst, or Researcher 🔬', 'Designer, Writer, or Content Creator 🎨', 'Doctor, Teacher, or Counsellor 🩺'], option_types: ['R', 'I', 'A', 'S'], correct: -1, trait: 'riasec' },
  { id: 51, text: '🧠 What are you naturally good at?', options: ['Fixing things that are broken 🛠️', 'Analysing data and finding logical patterns 🔍', 'Coming up with highly original, creative ideas 💡', 'Listening to people and giving good advice 💬'], option_types: ['R', 'I', 'A', 'S'], correct: -1, trait: 'riasec' },
  { id: 52, text: '💡 If you could invent something, it would be:', options: ['A cool new gadget or hardware device 📱', 'An app that organises schedules and tracks habits 📋', 'A new form of digital art or musical instrument 🎹', 'A service that helps students manage stress 💛'], option_types: ['R', 'C', 'A', 'S'], correct: -1, trait: 'riasec' },
  { id: 53, text: '🎤 If you started a podcast, the topic would be:', options: ['Tech gadgets and engineering marvels ⚙️', 'Exploring space, psychology, or deep science 🪐', 'Pop culture, movies, and the creative arts 🎬', 'Interviews with successful entrepreneurs 🚀'], option_types: ['R', 'I', 'A', 'E'], correct: -1, trait: 'riasec' },
  { id: 54, text: '🏅 What achievement would make you the proudest?', options: ['Scoring top marks in a tough Maths/Science paper 💯', 'Making a profitable trade or selling a product 💰', 'Performing brilliantly on stage or publishing a story 📖', 'Being voted the head boy/girl or team captain 👑'], option_types: ['I', 'E', 'A', 'E'], correct: -1, trait: 'riasec' },
  { id: 55, text: '🌱 If you volunteered for a school fest, you would:', options: ['Set up the sound system and stage lighting 🔌', 'Design the posters and promotional banners 🖌️', 'Manage the budget, ticket sales, and cash box 💵', 'Coordinate the volunteers and welcome guests 👋'], option_types: ['R', 'A', 'C', 'S'], correct: -1, trait: 'riasec' },
  { id: 56, text: '📖 Which of these books would you actually read?', options: ['"How Things Work: The Mechanics of the Modern World" ⚙️', '"A Brief History of Time" or "Freakonomics" 🧬', '"The Creative Habit" or a fictional fantasy novel 🌌', '"Rich Dad Poor Dad" or "Steve Jobs Biography" 📈'], option_types: ['R', 'I', 'A', 'E'], correct: -1, trait: 'riasec' },
  { id: 57, text: '🤝 How do you prefer to tackle a major assignment?', options: ['Build a working model or prototype on my own 🔧', 'Create a structured plan with clear steps and data 📊', 'Brainstorm a highly creative, unique presentation 🎨', 'Work in a group where everyone shares ideas 🙌'], option_types: ['R', 'C', 'A', 'S'], correct: -1, trait: 'riasec' },
  { id: 58, text: '😊 What is your favourite way to destress?', options: ['Going for a run, playing sports, or doing DIY 🏃', 'Going down a Wikipedia rabbit hole of interesting facts 🌍', 'Listening to music, sketching, or journaling 🎧', 'Calling a friend to chat and vent 📞'], option_types: ['R', 'I', 'A', 'S'], correct: -1, trait: 'riasec' },
  { id: 59, text: '🔭 Which lifestyle appeals to you the most?', options: ['Working with cutting-edge tech or building structures 🏗️', 'Running my own successful business or firm 🏢', 'Living a flexible life as a freelancer or artist 🎬', 'Working in healthcare or education to impact lives 🏥'], option_types: ['R', 'E', 'A', 'S'], correct: -1, trait: 'riasec' },
  { id: 60, text: '✨ Ultimately, you want your future work to be known for:', options: ['Its technical excellence and functionality ⚙️', 'Its flawless organisation and efficiency 📋', 'Its beauty, originality, and emotional impact 🎨', 'The positive difference it made in people\'s lives 💛'], option_types: ['R', 'C', 'A', 'S'], correct: -1, trait: 'riasec' },
];

export const GRADE_10_VARK_QUESTIONS: Question[] = [
  { id: 61, text: '📖 When a teacher explains a tough concept (like a physics law), you get it best when:', options: ['They draw a clear diagram on the board 📈', 'They explain it with a good real-life story 🗣️', 'You read the textbook definition carefully 📘', 'You get to test it out in the lab yourself 🧪'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 62, text: '🗺️ When trying to find a new cafe with friends, you prefer to:', options: ['Look at the route on Google Maps 🗺️', 'Ask someone for spoken directions 📣', 'Read the street names and address instructions 📝', 'Just start walking in the general direction 🚶'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 63, text: '📝 What do your class notes usually look like?', options: ['Lots of arrows, highlights, and doodles 🖍️', 'I barely write, I just listen closely 👂', 'Detailed paragraphs and bullet points 📋', 'Very messy—I only write what I absolutely have to 📌'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 64, text: '🎲 When you buy a new tech gadget, how do you figure it out?', options: ['Look at the quick-start visual guide 🖼️', 'Watch a YouTube review explaining how it works 🗣️', 'Read the manual cover-to-cover 📖', 'Press all the buttons until it works 🎮'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 65, text: '🔢 If you\'re stuck on a math problem, what helps the most?', options: ['Drawing a geometric figure or graph 📐', 'Talking through the steps out loud with a friend 💬', 'Looking at a solved example in the book 📘', 'Trying out different formulas on rough paper 🖊️'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 66, text: '⏳ It\'s the night before the board exams. How are you studying?', options: ['Reviewing my colourful mind maps and charts 🗂️', 'Explaining concepts out loud to my parents or mirror 🗣️', 'Re-reading my notes and the textbook chapters 📖', 'Solving past-year papers and mock tests 📝'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 67, text: '🌿 To memorize the digestive system in Biology, you would:', options: ['Draw the organs and colour-code them 🖍️', 'Make up a song or mnemonic to remember the order 🎵', 'Write down the functions of each organ repeatedly 📋', 'Use a 3D model or an interactive app 🌱'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 68, text: '📹 After watching an educational video, what sticks with you?', options: ['The cool graphics and animations they used 🖼️', 'The background music and the narrator\'s voice 💬', 'The text that popped up on the screen 📝', 'The experiments or physical actions shown 🎬'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 69, text: '🏠 When doing homework at your desk, you:', options: ['Need it to be visually aesthetic with nice stationery 🖊️', 'Need background music or lo-fi beats playing 🎶', 'Need absolute silence to focus on reading 🤫', 'Need to take breaks to walk around every 20 minutes 🏃'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 70, text: '🎭 If you had to present a history project, you would:', options: ['Make a visually stunning PowerPoint presentation 🎨', 'Give a really engaging and passionate speech 🎤', 'Write a highly detailed and researched report ✍️', 'Build a physical model of the historical site 🛠️'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 71, text: '🌈 What kind of assignment do you score best on?', options: ['Posters, infographics, and visual charts 🎨', 'Debates, vivas, and oral presentations 🗣️', 'Long essays and written assignments 📝', 'Lab practicals and hands-on experiments 🔬'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 72, text: '🏋️ When learning a new sport (like basketball or badminton), you prefer to:', options: ['Watch a pro do it and copy their form 📹', 'Listen to the coach explain the technique 🗣️', 'Read about the rules and strategies online 📖', 'Just grab the ball and start practicing immediately 🏃'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 73, text: '🎵 How do you memorize the lyrics to a new song?', options: ['Watch the music video or lyric video repeatedly 👁️', 'Just listen to the song on loop 🎧', 'Search up the lyrics and read them 📝', 'Sing along and dance to it 🎤'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 74, text: '🤔 When you are trying to explain a game to a friend, you:', options: ['Draw a quick sketch of how it works 🖼️', 'Explain the rules verbally in detail 💬', 'Send them a link to the rulebook 📘', 'Play a practice round to show them 🎭'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 75, text: '🗝️ What is your biggest distraction while studying?', options: ['A messy room or visual clutter 🖍️', 'People talking or loud noises outside 🎵', 'A poorly formatted or badly written textbook 📖', 'Feeling restless and wanting to move around 🎮'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 76, text: '🌟 If you had to describe your learning style, you\'d say:', options: ['"I need to see it to understand it." 👁️', '"I need to hear it to understand it." 👂', '"I need to read it to understand it." 📝', '"I need to do it to understand it." 🖐️'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 77, text: '📌 During an exam, if you forget an answer, you try to:', options: ['Visualize the page in your notebook where it was written 🖼️', 'Hear the teacher\'s voice explaining it in your head 🗣️', 'Remember the exact bullet points you memorized 📖', 'Remember the action or experiment you did 🧪'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 78, text: '💡 The best way for a teacher to teach is by:', options: ['Using lots of slides, videos, and visual aids 📊', 'Having interactive discussions and Q&A sessions 🗣️', 'Providing comprehensive notes and handouts 📘', 'Organizing field trips and practical activities 🔬'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 79, text: '🖐️ If you have to assemble a piece of IKEA furniture, you:', options: ['Follow the pictures in the manual closely 🖼️', 'Have a friend read the instructions out loud to you 📹', 'Read the written warnings and steps first 📚', 'Start putting pieces together to see what fits 🖊️'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
  { id: 80, text: '🎓 You feel most confident about a topic when:', options: ['You can map it all out visually 🖊️', 'You can debate or discuss it with someone 🗣️', 'You can write a perfect essay on it 📝', 'You can successfully apply it to a real problem 🏗️'], option_types: ['V', 'A', 'R', 'K'], correct: -1, trait: 'vark' },
];

export const GRADE_10_VALUES_QUESTIONS: Question[] = [
  { id: 81, text: '🌟 Fast forward 10 years. What do you want most from your career?', options: ['To be doing something highly creative and innovative 🎨', 'To be actively helping people or the environment 💛', 'To be earning a high salary and building wealth 💰', 'To be the CEO or leader making the big decisions 👑'], option_types: ['creativity', 'helping', 'financial', 'leadership'], correct: -1, trait: 'values' },
  { id: 82, text: '🏆 If you won an award at your high school graduation, what would you want it to be?', options: ['The Innovation & Creativity Award 🎨', 'The Social Impact & Empathy Award 💛', 'The Top Academic Achiever Award 📊', 'The Student Council Leadership Award 🏅'], option_types: ['creativity', 'helping', 'financial', 'leadership'], correct: -1, trait: 'values' },
  { id: 83, text: '💼 Which of these sounds like a nightmare job to you?', options: ['Working in a toxic team where everyone argues 🤝', 'A risky startup where you might lose your job tomorrow 🏠', 'A desk job where you do the exact same thing every day 🌍', 'A job where you have zero authority or say in decisions 👑'], option_types: ['teamwork', 'stability', 'adventure', 'leadership'], correct: -1, trait: 'values' },
  { id: 84, text: '😊 What makes you feel the most successful?', options: ['Designing or creating something beautiful and unique 🎨', 'Knowing you made someone\'s day better 💛', 'Overcoming a huge, thrilling challenge 🚀', 'Getting recognized and praised by important people 🌟'], option_types: ['creativity', 'helping', 'adventure', 'status'], correct: -1, trait: 'values' },
  { id: 85, text: '🔑 If your career was a superpower, it would be:', options: ['The power to bring imagination to life 🎨', 'The power to heal pain and solve social issues 💊', 'The power to command and inspire millions 🎤', 'The power to teleport and explore the world 🚀'], option_types: ['creativity', 'helping', 'leadership', 'adventure'], correct: -1, trait: 'values' },
  { id: 86, text: '🏠 Describe your dream workspace:', options: ['An aesthetic studio filled with art, plants, or tech 🎵', 'A hospital, school, or NGO making a difference 🏥', 'A sleek corporate office with a motivated team 🏢', 'No office—travelling and working from anywhere 🌿'], option_types: ['creativity', 'helping', 'teamwork', 'adventure'], correct: -1, trait: 'values' },
  { id: 87, text: '📅 What does an ideal Monday look like?', options: ['Brainstorming ideas for a brand new project 🛠️', 'Meeting clients or patients and helping them out 💬', 'Following a clear, organized schedule with no surprises 📋', 'Flying to a new city for an exciting assignment 🎉'], option_types: ['creativity', 'helping', 'stability', 'adventure'], correct: -1, trait: 'values' },
  { id: 88, text: '🤔 You have two job offers. You choose the one that:', options: ['Lets you express your ideas freely without strict rules ✨', 'Allows you to make a tangible impact on society 💛', 'Offers a much higher salary and bonuses 💰', 'Involves frequent travel and new experiences 🌍'], option_types: ['creativity', 'helping', 'financial', 'adventure'], correct: -1, trait: 'values' },
  { id: 89, text: '🌱 If you had unlimited money to change the world, you would:', options: ['Fund art, culture, and technological innovation 🎨', 'Build hospitals, schools, and eradicate poverty 💊', 'Invest in businesses to create massive economic growth 💰', 'Fund space exploration and global travel programs 🌍'], option_types: ['creativity', 'helping', 'financial', 'impact'], correct: -1, trait: 'values' },
  { id: 90, text: '🌟 When you retire, what do you want your legacy to be?', options: ['"They created masterpieces that changed the industry." 🎨', '"They saved lives and made the world kinder." 💛', '"They built a billion-dollar empire." 💼', '"They were a visionary leader who shaped the future." 👑'], option_types: ['creativity', 'helping', 'financial', 'leadership'], correct: -1, trait: 'values' },
  { id: 91, text: '🎯 What would you rather do this weekend?', options: ['Paint, write a song, or build a cool app 🖌️', 'Volunteer at an animal shelter or teach kids 💛', 'Organize an event and manage the team 📣', 'Go on an unplanned road trip or hike 🌿'], option_types: ['creativity', 'helping', 'leadership', 'adventure'], correct: -1, trait: 'values' },
  { id: 92, text: '💡 What excites you the most about growing up?', options: ['Having the freedom to invent and create 💡', 'Having the skills to support people who need it 🤝', 'Being able to afford a luxurious lifestyle 🌟', 'Achieving fame, prestige, and a high status 🏅'], option_types: ['creativity', 'helping', 'financial', 'status'], correct: -1, trait: 'values' },
  { id: 93, text: '🤝 In a group project, what is your biggest priority?', options: ['Making sure our project is the most creative and unique 💡', 'Making sure everyone feels included and unstressed 💛', 'Making sure we stick to the plan and finish on time 📋', 'Taking charge to ensure we get an A grade 👑'], option_types: ['creativity', 'helping', 'stability', 'leadership'], correct: -1, trait: 'values' },
  { id: 94, text: '🎁 You win ₹1,00,000. What do you do?', options: ['Buy high-end gear for your creative hobby (camera, PC) 🎨', 'Donate a large chunk to a charity you care about 🐾', 'Invest it in stocks or mutual funds to grow your wealth 💰', 'Book tickets for an international trip 🌍'], option_types: ['creativity', 'helping', 'financial', 'adventure'], correct: -1, trait: 'values' },
  { id: 95, text: '😔 What would make you quit a job immediately?', options: ['Being forced to follow strict rules with zero creativity 🚫', 'Working in a cut-throat, unfriendly environment 😶', 'Not knowing if I will get paid next month 😟', 'Doing mundane, repetitive tasks every single day 😴'], option_types: ['creativity', 'teamwork', 'stability', 'adventure'], correct: -1, trait: 'values' },
  { id: 96, text: '📣 If you had to give a TED Talk, the topic would be:', options: ['"Why Imagination is More Important Than Knowledge" 🎨', '"The Power of Empathy in a Disconnected World" 💛', '"How to Build Wealth and Financial Independence" 💰', '"Embracing Uncertainty and Living Adventurously" 🚀'], option_types: ['creativity', 'helping', 'financial', 'adventure'], correct: -1, trait: 'values' },
  { id: 97, text: '🔒 How important is a 9-to-5 predictable routine to you?', options: ['Not at all—I prefer working when inspiration strikes 🎨', 'Somewhat—but helping others is my main focus 💛', 'Very important—I value work-life balance and stability 🏠', 'I hate routine—I want every day to be a new challenge 🌍'], option_types: ['creativity', 'helping', 'stability', 'adventure'], correct: -1, trait: 'values' },
  { id: 98, text: '🌈 Choose an emoji that represents your ideal future:', options: ['🎨 (Creative, expressive, original)', '❤️ (Empathetic, healing, supportive)', '📈 (Wealthy, successful, growing)', '✈️ (Adventurous, free, exploring)'], option_types: ['creativity', 'helping', 'financial', 'adventure'], correct: -1, trait: 'values' },
  { id: 99, text: '🏅 What makes you feel the most proud right now?', options: ['Getting compliments on something you made or designed 🎨', 'Knowing you were there for a friend during a tough time 💛', 'Seeing your savings grow or making smart investments 📊', 'Successfully leading a team to victory 📣'], option_types: ['creativity', 'helping', 'financial', 'leadership'], correct: -1, trait: 'values' },
  { id: 100, text: '✨ If your life was a movie, the plot would be:', options: ['A visionary artist or inventor changing the world 🎨', 'A heroic doctor or social worker saving lives 💛', 'A brilliant entrepreneur building an empire from scratch 💰', 'An explorer discovering uncharted territories 🌍'], option_types: ['creativity', 'helping', 'financial', 'adventure'], correct: -1, trait: 'values' },
];
...
export const FBQ_GRADE10: { sections: Section[] } = {
  sections: [
    {
      id: 1, name: "Aptitude Assessment 🧠", icon: "🧠", color: "#690B1B", type: "mcq",
      description: "Tests cognitive abilities, reasoning, and problem-solving skills across 30 foundational questions.",
      questions: [
        { id: 1, text: "Your class teacher asks for a volunteer to lead a science exhibition team. What would you most likely do?", options: ["Volunteer to lead the team.", "Join the team and support the leader.", "Help only if someone asks me.", "Observe first before deciding."], correct: 0, trait: "verbal" },
        { id: 2, text: "You have a completely free Saturday. What sounds the most exciting?", options: ["Learning a new skill online.", "Playing sports or outdoor games.", "Creating art, music, or videos.", "Spending time with friends or family."], correct: 0, trait: "verbal" },
        { id: 3, text: "Your school announces a new club. Which one would you join first?", options: ["Robotics & AI Club", "Business & Entrepreneurship Club", "Drama & Performing Arts Club", "Nature & Social Service Club"], correct: 0, trait: "verbal" },
        { id: 4, text: "", options: ["difficult maths question appears in an exam. What is your first reaction?", "Skip it and return later.", "Stay calm and think carefully.", "Guess and move on."], correct: 0, trait: "verbal" },
        { id: 5, text: "Which compliment would make you happiest?", options: ["\"You're a great leader.\"", "\"You're very intelligent.\"", "\"You're really creative.\"", "\"You're kind and helpful.\""], correct: 0, trait: "verbal" },
        { id: 6, text: "If you could spend one day with any professional, who would you choose?", options: ["Scientist or Engineer", "Entrepreneur or CEO", "Artist or Filmmaker", "Doctor or Psychologist"], correct: 0, trait: "verbal" },
        { id: 7, text: "Your friends cannot decide where to eat after school. What do you do?", options: ["Suggest a place and convince everyone.", "Listen to everyone's opinions.", "Go wherever the majority chooses.", "Suggest trying somewhere new."], correct: 0, trait: "verbal" },
        { id: 8, text: "You receive ₹10,000 to improve your school. What would you spend it on?", options: ["Better computers and technology.", "More books and library resources.", "Sports equipment.", "Cultural events and activities."], correct: 0, trait: "verbal" },
        { id: 9, text: "Which school event would you enjoy organizing the most?", options: ["Science Exhibition", "Business Fair", "Cultural Festival", "Charity Fundraiser"], correct: 0, trait: "numerical" },
        { id: 10, text: "You are given a complicated LEGO or model-building kit. What do you do?", options: ["Read the instructions carefully.", "Start building and learn while doing.", "Ask someone to help.", "Watch a tutorial first."], correct: 0, trait: "numerical" },
        { id: 11, text: "Which subject do you usually look forward to the most?", options: ["Mathematics", "Science", "English or Social Science", "Art or Physical Education"], correct: 0, trait: "numerical" },
        { id: 12, text: "Your team loses an important competition. What do you do next?", options: ["Analyse what went wrong.", "Encourage everyone.", "Start preparing for the next one.", "Move on and try something different."], correct: 0, trait: "numerical" },
        { id: 13, text: "If you had one superpower, which would you choose?", options: ["Super Intelligence", "Healing Others", "Flying", "Creating Amazing Inventions"], correct: 0, trait: "numerical" },
        { id: 14, text: "Your teacher gives an open-ended project with no fixed instructions. What excites you the most?", options: ["Planning the project.", "Researching the topic.", "Designing the presentation.", "Working with my teammates."], correct: 0, trait: "numerical" },
        { id: 15, text: "When learning something new, what helps you the most?", options: ["Watching videos.", "Reading.", "Trying it myself.", "Discussing it with others."], correct: 0, trait: "numerical" },
        { id: 16, text: "Which app would you probably spend the most time using?", options: ["Coding or Learning Apps", "Finance or Business Apps", "Creative Editing Apps", "Social or Community Apps"], correct: 0, trait: "numerical" },
        { id: 17, text: "You find a wallet on the road. What do you do?", options: ["Try to find the owner.", "Hand it to the nearest authority.", "Ask nearby people.", "Look for identification inside."], correct: 0, trait: "reasoning" },
        { id: 18, text: "Which type of problem do you enjoy solving the most?", options: ["Logical puzzles.", "Real-life business situations.", "Creative challenges.", "Helping people solve personal problems."], correct: 0, trait: "reasoning" },
        { id: 19, text: "If your friend is nervous before an exam, how would you help?", options: ["Explain difficult topics.", "Motivate them.", "Share useful study tips.", "Help them relax."], correct: 0, trait: "reasoning" },
        { id: 20, text: "What kind of achievement would make you feel the proudest?", options: ["Winning a national competition.", "Starting a successful company.", "Creating something original.", "Making a positive impact on people."], correct: 0, trait: "reasoning" },
        { id: 21, text: "Which holiday sounds the most exciting?", options: ["Visiting a science museum.", "Exploring a new city.", "Attending an art or music festival.", "Going on an adventure in nature."], correct: 0, trait: "reasoning" },
        { id: 22, text: "You are asked to solve a community problem. What would you choose?", options: ["Improve technology.", "Create jobs or businesses.", "Improve education.", "Protect the environment."], correct: 0, trait: "reasoning" },
        { id: 23, text: "Your teacher asks everyone to present a topic. Which would you pick?", options: ["Artificial Intelligence", "Successful Entrepreneurs", "Ancient Civilizations", "Climate Change"], correct: 0, trait: "reasoning" },
        { id: 24, text: "Which hobby would you like to master?", options: ["Coding", "Investing", "Photography", "Public Speaking"], correct: 0, trait: "reasoning" },
        { id: 25, text: "Imagine yourself 15 years from now. Which goal sounds the most fulfilling?", options: ["Building innovative technology.", "Running a successful business.", "Becoming a well-known creator or designer.", "Improving lives through service or leadership."], correct: 0, trait: "spatial" },
        { id: 26, text: "Your teacher gives you a month to complete a project. What do you do first?", options: ["Make a detailed plan.", "Start working immediately.", "Research different ideas first.", "Wait until I feel inspired."], correct: 0, trait: "spatial" },
        { id: 27, text: "Which school competition would excite you the most?", options: ["Hackathon or Coding Challenge", "Business Pitch Competition", "Debate or Public Speaking", "Art, Dance, or Music Competition"], correct: 0, trait: "spatial" },
        { id: 28, text: "When you have a difficult decision to make, you usually...", options: ["Think logically about every option.", "Ask people I trust for advice.", "Follow my instincts.", "Imagine the long-term outcome."], correct: 0, trait: "spatial" },
        { id: 29, text: "If you could invent one thing, what would it be?", options: ["A smart technology gadget.", "A product that helps businesses.", "Something creative that entertains people.", "A solution that helps society."], correct: 0, trait: "spatial" },
        { id: 30, text: "Your friends describe you as...", options: ["Reliable", "Creative", "Friendly", "Curious"], correct: 0, trait: "spatial" },
      ]
    },
    {
      id: 2, name: "Personality Profile 🌟", icon: "🌟", color: "#7E3AF2", type: "choice",
      description: "Explores behavioral traits, communication style, resilience, and personal decision-making.",
      questions: [
        { id: 31, text: "Which activity sounds the most enjoyable?", options: ["Solving a Rubik's Cube or puzzle.", "Selling handmade products online.", "Writing a story or poem.", "Organizing a community event."], correct: -1, trait: "openness" },
        { id: 32, text: "You receive a difficult assignment with no clear instructions. What do you do?", options: ["Break it into smaller tasks.", "Ask the teacher for clarification.", "Look at examples online.", "Discuss ideas with friends."], correct: -1, trait: "conscientiousness" },
        { id: 33, text: "What motivates you the most?", options: ["Achieving difficult goals.", "Earning recognition.", "Learning something exciting.", "Helping others succeed."], correct: -1, trait: "extraversion" },
        { id: 34, text: "Which YouTube channel would you subscribe to first?", options: ["Science & Technology", "Business & Finance", "Travel & Lifestyle", "Art & Creativity"], correct: -1, trait: "agreeableness" },
        { id: 35, text: "You're given one week to learn a completely new skill. Which would you choose?", options: ["Programming", "Stock Market Basics", "Photography", "Public Speaking"], correct: -1, trait: "neuroticism" },
        { id: 36, text: "When working in a team, what role do you naturally take?", options: ["Planner", "Leader", "Creative Thinker", "Supporter"], correct: -1, trait: "openness" },
        { id: 37, text: "You have to prepare for an important exam. What's your study style?", options: ["Make a timetable.", "Practice as many questions as possible.", "Watch videos and understand concepts.", "Study with friends."], correct: -1, trait: "conscientiousness" },
        { id: 38, text: "Which achievement would make your parents the proudest?", options: ["Winning an academic award.", "Starting a successful business.", "Becoming famous for creativity.", "Making a positive difference in society."], correct: -1, trait: "extraversion" },
        { id: 39, text: "If your school allowed one new subject, which would you vote for?", options: ["Artificial Intelligence", "Entrepreneurship", "Film & Media", "Psychology"], correct: -1, trait: "agreeableness" },
        { id: 40, text: "You find yourself with an unexpected day off. What would you most likely do?", options: ["Learn something useful.", "Work on a personal project.", "Spend time with friends.", "Relax and recharge."], correct: -1, trait: "neuroticism" },
        { id: 41, text: "Which school trip sounds the most interesting?", options: ["ISRO or a Science Centre", "A Corporate Office", "A Film Studio", "A Wildlife Sanctuary"], correct: -1, trait: "openness" },
        { id: 42, text: "Your teacher asks everyone to solve the same problem. You prefer to...", options: ["Find the fastest solution.", "Find the smartest solution.", "Find the most creative solution.", "Work together with others."], correct: -1, trait: "conscientiousness" },
        { id: 43, text: "If you could instantly improve one quality, what would you choose?", options: ["Confidence", "Creativity", "Patience", "Communication"], correct: -1, trait: "extraversion" },
        { id: 44, text: "Your friend has a great idea but lacks confidence. What do you do?", options: ["Encourage them to try.", "Help improve their idea.", "Join them and work together.", "Suggest testing it first."], correct: -1, trait: "agreeableness" },
        { id: 45, text: "You are responsible for decorating your classroom. What would be your priority?", options: ["Make it organized.", "Make it informative.", "Make it beautiful.", "Make it interactive."], correct: -1, trait: "neuroticism" },
        { id: 46, text: "Which type of movie do you usually enjoy the most?", options: ["Science Fiction", "Business or Biography", "Comedy or Drama", "Mystery or Thriller"], correct: -1, trait: "openness" },
        { id: 47, text: "If you were starting your own YouTube channel, what would it be about?", options: ["Technology & Gadgets", "Business & Money", "Music, Art, or Entertainment", "Education & Motivation"], correct: -1, trait: "conscientiousness" },
        { id: 48, text: "Which achievement sounds the most exciting?", options: ["Creating an innovative app.", "Building a successful startup.", "Winning an international art competition.", "Leading a charity initiative."], correct: -1, trait: "extraversion" },
        { id: 49, text: "When something doesn't go as planned, what do you usually do?", options: ["Find another solution.", "Learn from the experience.", "Stay positive and try again.", "Ask for advice before continuing."], correct: -1, trait: "agreeableness" },
        { id: 50, text: "If your future career allowed you to choose only one of these, what would matter the most?", options: ["Solving complex problems.", "Financial success.", "Freedom to be creative.", "Making a meaningful impact on people's lives."], correct: -1, trait: "neuroticism" },
        { id: 51, text: "You have one month of summer vacation. How would you like to spend it?", options: ["Learning a new technical skill", "Starting a small business or project", "Exploring a creative hobby", "Volunteering or helping others"], correct: -1, trait: "openness" },
        { id: 52, text: "Your teacher asks everyone to create something from waste materials. What would you make?", options: ["A useful gadget", "Something that can be sold", "A creative artwork", "Something that benefits the community"], correct: -1, trait: "conscientiousness" },
        { id: 53, text: "You are working on a difficult puzzle. After 20 minutes, you're still stuck. What do you do?", options: ["Keep trying different approaches.", "Search for clues or hints.", "Ask someone for ideas.", "Take a break and return later."], correct: -1, trait: "extraversion" },
        { id: 54, text: "Your school is organizing a charity event. Which responsibility would you enjoy the most?", options: ["Planning and managing everything", "Managing the budget", "Designing posters and promotions", "Talking to people and collecting support"], correct: -1, trait: "agreeableness" },
        { id: 55, text: "If your school had an innovation lab, what would you build first?", options: ["A robot or AI project", "A useful product for students", "A creative game or app", "A project to solve a social problem"], correct: -1, trait: "neuroticism" },
        { id: 56, text: "Which achievement would make you happiest?", options: ["Inventing something useful", "Becoming financially successful", "Inspiring millions with creativity", "Changing people's lives positively"], correct: -1, trait: "openness" },
        { id: 57, text: "Which book would you probably pick first?", options: ["Science & Technology", "Business Success Stories", "Fiction or Fantasy", "Psychology or Self-Improvement"], correct: -1, trait: "conscientiousness" },
        { id: 58, text: "Your friends are arguing about an issue. What do you usually do?", options: ["Find a logical solution.", "Listen to both sides.", "Make everyone laugh.", "Help them reach a compromise."], correct: -1, trait: "extraversion" },
        { id: 59, text: "You are given ₹50,000 to start something. What would you choose?", options: ["Build an app or technology.", "Start a small business.", "Create a studio or creative space.", "Start a community project."], correct: -1, trait: "agreeableness" },
        { id: 60, text: "What kind of success matters most to you?", options: ["Solving important problems.", "Building wealth.", "Being recognized for creativity.", "Helping society."], correct: -1, trait: "neuroticism" },
      ]
    },
    {
      id: 3, name: "Interest Inventory 🎯", icon: "🎯", color: "#057A55", type: "choice",
      description: "Maps vocational interests using the internationally recognised RIASEC Holland Code framework.",
      questions: [
        { id: 61, text: "If you could shadow someone for one week, who would it be?", options: ["An engineer", "A business founder", "A filmmaker or designer", "A doctor or teacher"], correct: -1, trait: "riasec", option_types: ["I", "E", "A", "S"] },
        { id: 62, text: "When learning a new game, you usually...", options: ["Read the rules first.", "Learn while playing.", "Watch others first.", "Ask someone to teach me."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 63, text: "You notice one of your classmates sitting alone during lunch. What would you most likely do?", options: ["Invite them to join my group.", "Talk to them privately.", "Smile and check if they're okay.", "Give them space unless they ask for help."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 64, text: "If you had to organize your room, what would you focus on first?", options: ["Keeping everything systematic.", "Making it practical.", "Making it look attractive.", "Creating a comfortable space."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 65, text: "Your phone battery is almost dead during an important day. What do you do?", options: ["Plan my usage carefully.", "Find a charger immediately.", "Use it only when needed.", "Stay calm and manage without it."], correct: -1, trait: "riasec", option_types: ["S", "I", "A", "S"] },
        { id: 66, text: "What kind of challenge excites you the most?", options: ["Solving technical problems.", "Building something valuable.", "Creating something original.", "Helping solve social issues."], correct: -1, trait: "riasec", option_types: ["R", "R", "A", "I"] },
        { id: 67, text: "You are given an opportunity to learn one of these skills for free. Which would you choose?", options: ["Artificial Intelligence", "Digital Marketing", "Graphic Design", "Public Speaking"], correct: -1, trait: "riasec", option_types: ["A", "E", "A", "S"] },
        { id: 68, text: "When working with others, what is most important to you?", options: ["Everyone finishes their work.", "Everyone shares ideas.", "Everyone enjoys the experience.", "Everyone feels respected."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 69, text: "Your school announces a surprise quiz. What is your first thought?", options: ["Let's see how much I know.", "I hope I prepared well.", "I'll stay calm and try my best.", "This is a chance to learn where I can improve."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 70, text: "What would you most like to create in the future?", options: ["A groundbreaking invention.", "A successful company.", "A famous creative brand.", "A positive social movement."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 71, text: "Which activity sounds most satisfying?", options: ["Solving a coding challenge.", "Negotiating a successful deal.", "Producing a short film.", "Teaching someone a new skill."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 72, text: "Your friend asks for help before an exam, but you're also revising. What do you do?", options: ["Help them for a short time and continue studying.", "Finish my revision first, then help.", "Study together.", "Share notes and useful resources."], correct: -1, trait: "riasec", option_types: ["S", "S", "A", "S"] },
        { id: 73, text: "Which school award would you like to win?", options: ["Best Innovator", "Young Entrepreneur", "Best Performer", "Best Student Leader"], correct: -1, trait: "riasec", option_types: ["R", "E", "A", "E"] },
        { id: 74, text: "If your school principal asked for one improvement idea, what would you suggest?", options: ["Better technology and labs.", "More career and financial education.", "More arts and creative activities.", "More mental health and wellness support."], correct: -1, trait: "riasec", option_types: ["I", "S", "A", "S"] },
        { id: 75, text: "Imagine you are 30 years old. Which statement would make you feel the most proud?", options: ["\"I solved problems that improved people's lives.\"", "\"I built a successful business from scratch.\"", "\"My creativity inspires millions.\"", "\"I helped people become happier and more successful.\""], correct: -1, trait: "riasec", option_types: ["I", "E", "A", "S"] },
        { id: 76, text: "Your school is starting a student council. Which position would you choose?", options: ["President", "Treasurer", "Event Coordinator", "Welfare Representative"], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 77, text: "If you had to learn a completely new language, how would you begin?", options: ["Use learning apps every day.", "Watch videos and movies.", "Practice speaking with people.", "Read books and notes."], correct: -1, trait: "riasec", option_types: ["R", "I", "S", "S"] },
        { id: 78, text: "Your friend has an amazing idea but doesn't know how to start. What would you do?", options: ["Help create a step-by-step plan.", "Encourage them to take the first step.", "Join them and work together.", "Connect them with someone who can help."], correct: -1, trait: "riasec", option_types: ["S", "I", "A", "S"] },
        { id: 79, text: "Which type of challenge excites you the most?", options: ["Building something from scratch.", "Solving a real-life business problem.", "Creating something unique.", "Helping people overcome difficulties."], correct: -1, trait: "riasec", option_types: ["R", "E", "A", "S"] },
        { id: 80, text: "You are asked to plan a one-day school trip. What would you focus on first?", options: ["Making a detailed schedule.", "Managing the budget.", "Choosing exciting activities.", "Ensuring everyone enjoys the trip."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 81, text: "When learning about a new topic, what interests you most?", options: ["How it works.", "How it can earn money.", "How it can be improved creatively.", "How it helps people."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 82, text: "You have one hour before an exam unexpectedly gets postponed. What do you do?", options: ["Revise difficult topics.", "Solve practice questions.", "Relax and refresh my mind.", "Help friends revise."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 83, text: "Which achievement sounds the most exciting?", options: ["Designing a useful mobile app.", "Owning a successful company.", "Directing a popular movie.", "Leading an organization that changes lives."], correct: -1, trait: "riasec", option_types: ["A", "I", "A", "E"] },
        { id: 84, text: "Your teacher asks everyone to suggest a new school activity. What do you recommend?", options: ["Innovation Lab", "Business & Investment Club", "Film & Photography Club", "Community Service Club"], correct: -1, trait: "riasec", option_types: ["R", "E", "A", "S"] },
        { id: 85, text: "What do you usually notice first when visiting a new place?", options: ["Technology and infrastructure.", "Shops and businesses.", "Architecture and design.", "The people and culture."], correct: -1, trait: "riasec", option_types: ["I", "E", "A", "S"] },
        { id: 86, text: "If you could solve one global problem, which would you choose?", options: ["Better technology for everyone.", "Poverty and unemployment.", "Education for every child.", "Climate change."], correct: -1, trait: "riasec", option_types: ["I", "I", "A", "S"] },
        { id: 87, text: "Which activity would you enjoy the most during a school festival?", options: ["Robotics Competition", "Business Stall", "Dance, Music, or Art Exhibition", "Organizing volunteers"], correct: -1, trait: "riasec", option_types: ["R", "E", "A", "S"] },
        { id: 88, text: "When someone disagrees with your opinion, you usually...", options: ["Explain my reasoning calmly.", "Listen before responding.", "Try to find common ground.", "Respect their opinion and move on."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
        { id: 89, text: "If you were given a chance to interview someone, who would you choose?", options: ["A scientist or inventor.", "A successful entrepreneur.", "A famous artist or actor.", "A social leader."], correct: -1, trait: "riasec", option_types: ["R", "E", "A", "S"] },
        { id: 90, text: "You are asked to improve your school's website. What would you focus on first?", options: ["Adding useful features.", "Making it easier to use.", "Improving the design.", "Making information easier to find."], correct: -1, trait: "riasec", option_types: ["R", "I", "A", "S"] },
      ]
    },
    {
      id: 4, name: "Learning Style Analysis 📚", icon: "📚", color: "#C9A55D", type: "choice",
      description: "Identifies primary study and learning preferences using the VARK framework.",
      questions: [
        { id: 91, text: "Your group has only one day left before submitting a project. What role do you naturally take?", options: ["Finish the most important tasks.", "Organize everyone efficiently.", "Improve the presentation.", "Keep everyone's motivation high."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 92, text: "What would you enjoy doing during an internship?", options: ["Solving technical problems.", "Understanding how businesses work.", "Creating content or designs.", "Working directly with people."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 93, text: "Which app idea sounds the most interesting to build?", options: ["AI Homework Assistant", "Personal Finance Manager", "Video Editing Platform", "Mental Wellness App"], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 94, text: "When you receive feedback on your work, you usually...", options: ["Improve it immediately.", "Ask questions to understand better.", "Compare it with my own ideas.", "Appreciate the suggestions and learn."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 95, text: "Your school announces an overnight leadership camp. What excites you the most?", options: ["Team challenges.", "Planning activities.", "Meeting new people.", "Learning leadership skills."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 96, text: "Which future workplace sounds most appealing?", options: ["A technology company.", "My own startup.", "A creative design studio.", "A hospital, school, or NGO."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 97, text: "You have to learn a difficult concept. Which method would you choose first?", options: ["Watch an animation or video.", "Read detailed notes.", "Practice with examples.", "Discuss it with someone."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 98, text: "Your friends ask you to plan a weekend activity. What would you suggest?", options: ["Visit a science museum or tech event.", "Explore a local business or startup event.", "Attend an art, music, or cultural festival.", "Go trekking or volunteer together."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 99, text: "Imagine you could master one life skill today. Which would you choose?", options: ["Critical Thinking", "Financial Management", "Creative Storytelling", "Emotional Intelligence"], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 100, text: "At the end of your career, how would you like people to remember you?", options: ["As someone who built innovative solutions.", "As someone who created successful businesses.", "As someone whose creativity inspired others.", "As someone who made the world a better place."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 101, text: "Your school announces a \"Future Careers Week.\" Which workshop would you attend first?", options: ["Artificial Intelligence & Robotics", "Business & Startups", "Design & Digital Media", "Psychology & Human Behaviour"], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 102, text: "You have to solve a problem affecting your school. Which one would you choose?", options: ["Improve classroom technology.", "Reduce unnecessary expenses.", "Make the campus more attractive.", "Improve student well-being."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 103, text: "", options: ["younger student asks for your help with homework. What do you do?", "Give them useful resources.", "Solve one example together.", "Encourage them to try first."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 104, text: "If you could create a new school subject, what would it be?", options: ["AI & Future Technology", "Money Management", "Digital Content Creation", "Life Skills & Mental Wellness"], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 105, text: "Your team has two good ideas but only one can be selected. What do you do?", options: ["Compare the pros and cons.", "Vote as a team.", "Combine the best parts of both ideas.", "Let the teacher decide."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 106, text: "Which achievement would you proudly share with your family?", options: ["Winning a national science competition.", "Launching my own business.", "Publishing my own creative work.", "Leading a successful social campaign."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 107, text: "If your phone stopped working for a week, how would you feel?", options: ["I'd spend time learning something new.", "I'd focus on other productive activities.", "I'd enjoy more offline hobbies.", "I'd spend more time with people around me."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 108, text: "Which type of project sounds the most exciting?", options: ["Build a smart robot.", "Create a business plan.", "Design a mobile game.", "Organize a charity campaign."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 109, text: "Your friend wants to start a small business. How would you help?", options: ["Suggest useful technology.", "Help create a budget.", "Design a logo and branding.", "Help find customers."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 110, text: "You are given one wish to improve your city. What would you choose?", options: ["Better public technology.", "More jobs and businesses.", "More parks and creative spaces.", "Better healthcare and education."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 111, text: "Which type of news catches your attention first?", options: ["Scientific discoveries.", "Business and finance.", "Entertainment and culture.", "Environment and society."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 112, text: "Imagine your class has won ₹1,00,000 for a project. How should it be used?", options: ["Upgrade labs and technology.", "Invest in future school projects.", "Improve arts and cultural activities.", "Support students who need help."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 113, text: "If you had to work on one project for an entire year, what would you choose?", options: ["Inventing a useful product.", "Building a startup.", "Making a documentary.", "Solving a community problem."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 114, text: "What do you enjoy most while learning?", options: ["Solving difficult questions.", "Understanding practical uses.", "Creating something new.", "Discussing ideas with others."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 115, text: "If your teacher asked you to mentor junior students, what would you do?", options: ["Teach them difficult concepts.", "Help them achieve their goals.", "Make learning enjoyable.", "Encourage and motivate them."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 116, text: "Which future invention would excite you the most?", options: ["Smart medical robots.", "AI-powered businesses.", "Virtual reality entertainment.", "Clean energy solutions."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 117, text: "Your school is choosing a theme for Annual Day. Which idea would you support?", options: ["Future Technology", "Young Entrepreneurs", "Culture & Creativity", "Unity & Social Change"], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 118, text: "When facing a difficult challenge, what gives you confidence?", options: ["My knowledge.", "My planning.", "My creativity.", "The support of others."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 119, text: "Which extracurricular activity would help you grow the most?", options: ["Coding Competition", "Investment Club", "Theatre Workshop", "Community Service"], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
        { id: 120, text: "What would you most like to be known for in school?", options: ["Solving difficult problems.", "Coming up with smart ideas.", "Being creative and original.", "Being supportive and dependable."], correct: -1, trait: "vark", option_types: ["V", "A", "R", "K"] },
      ]
    },
    {
      id: 5, name: "Career Values Explorer 💼", icon: "💼", color: "#0694A2", type: "choice",
      description: "Clarifies long-term workplace motivations, financial goals, and personal career values.",
      questions: [
        { id: 121, text: "You are asked to improve your classroom. Which idea would you choose?", options: ["Smart boards and better technology.", "Better organization and planning tools.", "Creative displays and artwork.", "Comfortable spaces for teamwork."], correct: -1, trait: "values", option_types: ["creativity", "helping", "creativity", "teamwork"] },
        { id: 122, text: "If you had to choose one personal goal this year, what would it be?", options: ["Learn a technical skill.", "Save and manage money better.", "Build a creative portfolio.", "Improve my communication skills."], correct: -1, trait: "values", option_types: ["financial", "financial", "creativity", "impact"] },
        { id: 123, text: "Your team wins a competition because of everyone's efforts. What do you do first?", options: ["Thank the entire team.", "Celebrate the achievement.", "Appreciate everyone's unique contribution.", "Think about how to improve even further."], correct: -1, trait: "values", option_types: ["teamwork", "helping", "financial", "impact"] },
        { id: 124, text: "Which type of challenge would you happily spend weeks solving?", options: ["A coding or engineering challenge.", "A business strategy challenge.", "A design or storytelling challenge.", "A social impact challenge."], correct: -1, trait: "values", option_types: ["creativity", "helping", "creativity", "impact"] },
        { id: 125, text: "If your future job could give you only one of these, which would you choose?", options: ["Continuous learning and innovation.", "Financial independence.", "Creative freedom.", "The opportunity to improve people's lives."], correct: -1, trait: "values", option_types: ["creativity", "financial", "creativity", "helping"] },
        { id: 126, text: "You have to choose one weekend activity. Which would you enjoy the most?", options: ["Attend a coding or robotics workshop.", "Visit a startup or business exhibition.", "Attend an art, music, or photography workshop.", "Volunteer at a community event."], correct: -1, trait: "values", option_types: ["creativity", "creativity", "creativity", "leadership"] },
        { id: 127, text: "Your teacher asks your class to solve a local community problem. Which issue would you choose?", options: ["Traffic and transportation.", "Supporting local businesses.", "Beautifying public spaces.", "Helping underprivileged children."], correct: -1, trait: "values", option_types: ["creativity", "helping", "financial", "helping"] },
        { id: 128, text: "You have one hour before school starts unexpectedly. What would you most likely do?", options: ["Solve practice questions.", "Plan my upcoming week.", "Read or explore something interesting.", "Chat and spend time with friends."], correct: -1, trait: "values", option_types: ["creativity", "helping", "financial", "teamwork"] },
        { id: 129, text: "If you could create one mobile app, what would it be?", options: ["AI Study Assistant", "Budget & Money Manager", "Creative Content Creator", "Mental Health Companion"], correct: -1, trait: "values", option_types: ["creativity", "financial", "creativity", "leadership"] },
        { id: 130, text: "Your friend asks you to join a competition outside your comfort zone. What would you do?", options: ["Accept the challenge immediately.", "Learn more before deciding.", "Join if I can contribute creatively.", "Support my friend instead."], correct: -1, trait: "values", option_types: ["creativity", "financial", "creativity", "teamwork"] },
        { id: 131, text: "Which achievement sounds the most rewarding?", options: ["Winning an innovation award.", "Building a profitable company.", "Creating a bestselling book or film.", "Improving thousands of lives."], correct: -1, trait: "values", option_types: ["creativity", "helping", "financial", "leadership"] },
        { id: 132, text: "If you had to spend one month learning only one skill, what would you choose?", options: ["Artificial Intelligence", "Marketing & Sales", "Video Editing & Animation", "Leadership & Communication"], correct: -1, trait: "values", option_types: ["creativity", "helping", "financial", "leadership"] },
        { id: 133, text: "Your school asks students to design the next annual event. What would you focus on?", options: ["Interactive technology.", "Sponsorship and budgeting.", "Entertainment and creativity.", "Student participation."], correct: -1, trait: "values", option_types: ["creativity", "helping", "financial", "creativity"] },
        { id: 134, text: "What usually inspires you the most?", options: ["New inventions.", "Successful entrepreneurs.", "Creative artists.", "People making a positive difference."], correct: -1, trait: "values", option_types: ["creativity", "helping", "creativity", "helping"] },
        { id: 135, text: "", options: ["difficult challenge takes longer than expected. What do you usually do?", "Look for smarter alternatives.", "Think of a new creative approach.", "Ask others for ideas and feedback."], correct: -1, trait: "values", option_types: ["creativity", "creativity", "creativity", "leadership"] },
        { id: 136, text: "If your school offered an international exchange program, what would excite you most?", options: ["Learning new technology.", "Understanding global businesses.", "Experiencing different cultures.", "Making new friends."], correct: -1, trait: "values", option_types: ["financial", "helping", "impact", "teamwork"] },
        { id: 137, text: "Your younger sibling wants career advice. Which suggestion would you most likely give?", options: ["Learn future technologies.", "Learn how money works.", "Discover your creativity.", "Follow what makes you happy."], correct: -1, trait: "values", option_types: ["financial", "financial", "financial", "leadership"] },
        { id: 138, text: "Which project would you proudly spend six months completing?", options: ["A science innovation.", "A startup business.", "A documentary or creative film.", "A social awareness campaign."], correct: -1, trait: "values", option_types: ["creativity", "creativity", "creativity", "leadership"] },
        { id: 139, text: "Which type of success motivates you the most?", options: ["Recognition for innovation.", "Financial independence.", "Creative appreciation.", "Positive social impact."], correct: -1, trait: "values", option_types: ["creativity", "financial", "creativity", "impact"] },
        { id: 140, text: "Your principal asks students to suggest one improvement for education. What would you recommend?", options: ["More practical technology learning.", "Financial literacy classes.", "More creative subjects.", "More life skills and emotional learning."], correct: -1, trait: "values", option_types: ["financial", "financial", "creativity", "financial"] },
        { id: 141, text: "If you could spend one day working with a famous person, who would you choose?", options: ["A scientist or engineer.", "A business leader.", "A filmmaker or designer.", "A humanitarian or social reformer."], correct: -1, trait: "values", option_types: ["creativity", "leadership", "creativity", "leadership"] },
        { id: 142, text: "What gives you the greatest sense of achievement?", options: ["Solving a difficult challenge.", "Achieving a personal goal.", "Creating something original.", "Helping someone succeed."], correct: -1, trait: "values", option_types: ["creativity", "helping", "financial", "helping"] },
        { id: 143, text: "You have ₹1,00,000 to start a project. What would you choose?", options: ["Develop a useful technology.", "Launch a business.", "Build a creative studio.", "Start a community initiative."], correct: -1, trait: "values", option_types: ["creativity", "helping", "creativity", "creativity"] },
        { id: 144, text: "If your classmates described you in one sentence, what would you like them to say?", options: ["\"Always comes up with smart solutions.\"", "\"Knows how to achieve goals.\"", "\"Has amazing ideas.\"", "\"Makes everyone feel included.\""], correct: -1, trait: "values", option_types: ["creativity", "helping", "financial", "leadership"] },
        { id: 145, text: "Which quote matches your thinking the most?", options: ["\"Every problem has a solution.\"", "\"Opportunities are created, not found.\"", "\"Creativity changes the world.\"", "\"Helping others is the greatest success.\""], correct: -1, trait: "values", option_types: ["creativity", "creativity", "impact", "helping"] },
        { id: 146, text: "If you could improve one thing about yourself today, what would it be?", options: ["My technical knowledge.", "My financial understanding.", "My creative confidence.", "My communication with people."], correct: -1, trait: "values", option_types: ["creativity", "financial", "creativity", "helping"] },
        { id: 147, text: "You are invited to speak at your school's farewell ceremony. What would you mostly talk about?", options: ["Innovation and future careers.", "Dreams and success.", "Creativity and self-expression.", "Friendship and kindness."], correct: -1, trait: "values", option_types: ["creativity", "helping", "financial", "helping"] },
        { id: 148, text: "If your future job required constant learning, how would you feel?", options: ["Excited—I enjoy learning new things.", "Motivated if it helps me grow.", "Happy if I can apply my creativity.", "Comfortable if I can help people along the way."], correct: -1, trait: "values", option_types: ["financial", "helping", "financial", "helping"] },
        { id: 149, text: "Imagine you're leading a team to build something meaningful. Which project would you choose?", options: ["A smart city solution.", "A startup solving everyday problems.", "A creative platform for young artists.", "A non-profit organization helping communities."], correct: -1, trait: "values", option_types: ["creativity", "creativity", "creativity", "helping"] },
        { id: 150, text: "Twenty years from now, what would make you feel that your life has been successful?", options: ["I created technology that improved people's lives.", "I built a successful and ethical business.", "I inspired people through creativity and innovation.", "I made a lasting positive impact on society."], correct: -1, trait: "values", option_types: ["creativity", "helping", "creativity", "helping"] },
      ]
    }
  ]
};
...
export const API_KEY = process.env.NEXT_PUBLIC_GROQ_API_KEY || process.env.GROQ_API_KEY || '';
export const API_URL = API_KEY.startsWith('AQ.')
  ? 'https://generativelanguage.googleapis.com/v1beta/openai/chat/completions'
  : 'https://api.groq.com/openai/v1/chat/completions';
export const MODELS = API_KEY.startsWith('AQ.')
  ? ['gemini-1.5-flash', 'gemini-1.5-flash-8b', 'gemini-2.0-flash-exp', 'gemini-1.5-pro']
