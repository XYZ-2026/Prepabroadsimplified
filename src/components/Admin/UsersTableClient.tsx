...
export interface UserData extends StudentProfileData {
  id: string;
  name: string;
  email: string;
  mobile: string;
      ...
      <div style={{ width: '100%' }}>
        ...
        <div style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
          ...
          <span style={{ fontSize: '13px', color: '#64748b' }}>
            Viewing Profile for <strong>{selectedUser.name}</strong>
          </span>
        </div>

        {/* Full-Width Redesigned Student Profile */}
        <StudentProfileView student={selectedUser} hideHeaderTitle={true} />
      </div>
    );
  }
