  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'users', user.uid), {
        ...
        studentType: regRole === 'student' ? regType : '',
        state: regState,
        city: regCity.trim(),
        role: regRole,
        toolAccess: {
  ...
  return (
    <div className={styles.authContainer}>
      ...
      <div className={activeTab === 'register' ? styles.authFormContainerActive : styles.authFormContainer}>
              ...
              <div style={{ display: 'flex', gap: '6px' }}>
                <button
                  ...
                  style={{
                    ...
                    padding: '6px 8px',
                    borderRadius: '6px',
                    border: regRole === 'student' ? '2px solid var(--accent)' : '1px solid #e0e0e0',
                    background: regRole === 'student' ? 'var(--accent-light, rgba(220, 38, 38, 0.08))' : '#fff',
                    color: regRole === 'student' ? 'var(--accent)' : '#666',
                    fontWeight: regRole === 'student' ? 600 : 400,
                    cursor: 'pointer',
                    fontSize: '12px',
                    display: 'flex',
                    alignItems: 'center',
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: '6px 8px',
                    borderRadius: '6px',
                    border: regRole === 'counsellor' ? '2px solid #7c3aed' : '1px solid #e0e0e0',
                    background: regRole === 'counsellor' ? 'rgba(124, 58, 237, 0.08)' : '#fff',
                    color: regRole === 'counsellor' ? '#7c3aed' : '#666',
                    fontWeight: regRole === 'counsellor' ? 600 : 400,
                    cursor: 'pointer',
                    fontSize: '12px',
                    display: 'flex',
                    alignItems: 'center',
        ...
        <p className={styles.authFooterLink} style={{ marginTop: '10px' }}>
